...
<div class="row feature-box">
    ...
    <div class="span4">
        <img src="./template/web/img/Toeic-Listening.png" height="100px" width="100px">
    ...
    <div class="span4">
        <img src="./template/web/img/Toeic-exercise.jpg" height="100px" width="100px">
    ...
    <div class="span4">
        <img src="./template/web/img/exams-2.jpg" height="150px" width="150px">
