...
import java.sql.Timestamp;
/*	
	bảng CÂU HỎI của BÀI KIỂM TRA
	examinationquestionid
	image: hình ảnh của câu hỏi
	paragraph:
	audio:
	...
	createddate
	modifidate
	type: dạng của câu hỏi (nghe hoặc đọc)
	examinationid: khóa ngoại tham chiếu đến Examination
*/
@Entity
...
public class ExaminationQuestionEntity {
	...
	private ExaminationEntity examination; // khóa ngoại tham chiếu đến Examination
